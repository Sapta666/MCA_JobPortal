...
@Component({
  selector: 'app-manage-jobseeker-chat',
  templateUrl: './manage-jobseeker-chat.component.html'
})
export class ManageJobseekerChatComponent implements OnInit, AfterContentInit, OnDestroy {
  ...
  ngOnInit(): void {
    this._activatedRoute.params.subscribe(params => {
      this._employer_user_id = params["jobseeker_user_id"];
  ...
  protected onSendMessageClick(): void {
    let createNewChat: CreateNewChatDto = {
      ...
      employer_id: this.appSettings.employer_id,
      jobseeker_id: this.jobseekerInfo.JobseekerDetails.jobseeker_id,
  ...
  private getJobseekerInfo(): void {
    this._userService
      .getJobseekerInfo(this._employer_user_id)
